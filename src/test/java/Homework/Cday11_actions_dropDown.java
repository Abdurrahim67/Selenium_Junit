...
public class Cday11_actions_dropDown {
...
//sonuc sayisi bildiren yazinin iphone icerdigini test edin
       String actualSonuc= driver.findElement(By.xpath("//*[text()='f1-24 von mehr als 1.000 Ergebnissen oder Vorschlägen für']")).getText();
